...
const ExpElement: React.FC<ExpElementProps> = ({
    ...
    const rest =
        description && description.length > 1 ? description.slice(1) : [];
    ...
    return (
        <section className="flex flex-col lg:flex-row bg-gradient-to-br from-slate-900 via-slate-950 to-slate-900 rounded-md w-full h-auto lg:h-[32rem] overflow-hidden shadow-lg">
            ...
            <div
                className={`${img ? 'lg:w-7/12' : 'w-full'} px-6 lg:p-10 overflow-auto scrollbar scrollbar-thumb-slate-600 scrollbar-track-slate-800 mb-5`}
            >
                ...
                <div className="pt-4 flex flex-wrap gap-4">
                    {gitRepo && (
                        <ExpLink href={gitRepo}>Git Repository</ExpLink>
                    )}
